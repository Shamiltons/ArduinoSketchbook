...
const int F = 255; // dec value for F
int crc1 = 0;
int crc2 = 0;
String msg = "0";
String byte1 = "0";
...
byte1 = String(radio.DATA[0], HEX);
byte2 = String(radio.DATA[1], HEX);
byte3 = String(radio.DATA[2], HEX);
byte4 = String(radio.DATA[3], HEX);
byte5 = String(radio.DATA[4], HEX);
byte6 = String(radio.DATA[5], HEX);
byte7 = String(radio.DATA[6], HEX);
byte8 = String(radio.DATA[7], HEX);
byte9 = String(radio.DATA[8], HEX);
byte10 = String(radio.DATA[9], HEX);
   Serial.print("\n");
   crc1 = (radio.DATA[8]);
   crc2 = (radio.DATA[9]);
  Serial.print(crc1);
  ...
  Serial.print(byte1 + byte2 + byte3 + byte4 + byte5 + byte6 + byte7 + byte8 + byte9 +byte10);
//  Serial.print(byte1);
  if (crc1 == F & crc2 == F ){
  Serial.print("\n");
  msg = (byte1 + byte2 + byte3 + byte4 + byte5 + byte6 + byte7 + byte8 + byte9 +byte10);
